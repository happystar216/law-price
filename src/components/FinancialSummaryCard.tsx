    ...
    <div className="bg-white rounded-2xl p-5 sm:p-7 border border-slate-200/80 shadow-sm space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 pb-4 gap-2">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h2 className="text-base sm:text-lg font-bold text-slate-900">诉讼全景费用大盘（金钱账本）</h2>
            <p className="text-xs text-slate-500">法定诉讼费 + 律协参考费率 + 保全执行全要素测算</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 relative overflow-hidden shadow-md">
          ...
          <div className="text-xs text-slate-400 font-medium flex items-center justify-between">
            <span>前期启动需垫付资金 (现金流)</span>
            <span className="text-[10px] px-2 py-0.5 rounded-md bg-slate-800 text-slate-300">预交待返还</span>
          </div>
          ...
          <p className="text-[11px] text-slate-400 mt-2 leading-relaxed">
            包含：应预交法院诉讼费（¥{financial.courtFeeDiscounted.toLocaleString()}）+ 律师费 + 保全费。胜诉后法定诉讼费与保全费全额由对方承担并退还。
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-900 to-teal-900 text-white rounded-2xl p-5 relative overflow-hidden shadow-md">
          <div className="absolute right-0 top-0 translate-x-4 -translate-y-4 w-28 h-28 bg-emerald-400/10 rounded-full blur-xl pointer-events-none" />
          <div className="text-xs text-emerald-300 font-medium flex items-center justify-between">
            <span>胜诉后当事人终局实际成本</span>
            <span className="text-[10px] px-2 py-0.5 rounded-md bg-emerald-950 text-emerald-300 font-semibold">退费后净支出</span>
          </div>
          ...
          <p className="text-[11px] text-emerald-100/70 mt-2 leading-relaxed">
            {financial.canTransferLawyerFee
              ? '✨ 依据转嫁规则，律师费与诉讼费均由对方买单，您仅需承担极低保全保费。'
              : '诉讼费由败诉方全额返还，您的终局成本主要为律师代理费与保全保险支出。'}
          </p>
        </div>
      </div>
      ...
      <div className="border border-slate-200 rounded-xl overflow-hidden text-xs">
        <div className="bg-slate-50 px-4 py-2.5 font-bold text-slate-700 grid grid-cols-12 border-b border-slate-200">
          <div className="col-span-4 sm:col-span-3">费用名目</div>
          <div className="col-span-4 sm:col-span-3">金额参考</div>
          <div className="col-span-4 sm:col-span-3">承担归属规则</div>
          <div className="hidden sm:block sm:col-span-3 text-right">收费法定依据</div>
        </div>
        ...
        <div className="divide-y divide-slate-100">
          <div className="px-4 py-3 grid grid-cols-12 items-center hover:bg-slate-50/60 transition-colors">
            ...
            <div className="col-span-4 sm:col-span-3 text-emerald-700 font-medium">
              胜诉由败诉方全额承担
            </div>
          ...
          <div className="px-4 py-3 grid grid-cols-12 items-center hover:bg-slate-50/60 transition-colors">
            ...
            <div className="col-span-4 sm:col-span-3 font-bold text-slate-900">
              ...
              <div className="text-[10px] text-slate-400 font-normal">
                中位均价: ¥{financial.lawyerFeeMedian.toLocaleString()}
              </div>
            </div>
            <div className="col-span-4 sm:col-span-3">
              {financial.canTransferLawyerFee ? (
                <span className="text-emerald-700 font-semibold">依法可请求对方报销</span>
              ) : (
                <span className="text-slate-600">委托人自行承担</span>
              )}
            </div>
            <div className="hidden sm:block sm:col-span-3 text-right text-slate-400 text-[11px]">
              省律协指导标准与市场化协商
          ...
          <div className="px-4 py-3 grid grid-cols-12 items-center hover:bg-slate-50/60 transition-colors">
            ...
            <div className="col-span-4 sm:col-span-3 text-blue-700 font-medium">
              前期无需预交（回款中扣）
            </div>
            <div className="hidden sm:block sm:col-span-3 text-right text-slate-400 text-[11px]">
              《诉讼费用交纳办法》第14条
      ...
      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-xs flex items-start space-x-2.5">
        ...
        <div>
          <span className="font-bold text-slate-800">关于本案律师费转嫁支持的法律依据：</span>
