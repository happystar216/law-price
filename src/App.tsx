...
export function App() {
  ...
  const [caseInput, setCaseInput] = useState<CaseInputState>({
    ...
    isPropertyCase: true,
    claimAmount: 100000,
    clientResidenceRegionId: 'bj',
    clientDomicileRegionId: 'bj',
    clientDomicileSameAsResidence: true,
    opponentResidenceRegionId: 'gd',
    opponentDomicileRegionId: 'sc',
    opponentDomicileSameAsResidence: false,
    chosenVenueKey: 'client_residence',
    regionId: 'bj',
    isOpponentCity: false,
